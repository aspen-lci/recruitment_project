<?php require_once('../../../private/initialize.php'); 
  if(!isset($page_title)) {$page_title = 'HR Intern Dashboard';}
          ...
          <div class="row">
            <div class="col-lg-12 mb-4">
              <div class="card shadow mb-4">
                ...
                <a class="btn" href="<?php echo url_for('/hr/index.php') ?>">View Candidates</a>
                ...
                <tr style="overflow-wrap:break-word;">
                    ...
                    <th colspan="1"></th>
                    <th colspan="13" class="text-center">Documents Received</th>
                  </tr>
                ...
                <tbody>
                  ...
                  <tr data-has-detail-view="true">
                    <td><a class="action" href="<?php echo url_for('/hr/hr_interns/edit.php?id=' . h($candidate['candidate_id'])); ?>"><?php echo (h($candidate['first_name']) . ' ' . h($candidate['last_name'])); ?></a></td>
