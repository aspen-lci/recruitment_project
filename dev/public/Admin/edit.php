...
<a class="btn d-flex" type="button" href="#">Companies</a>
<a class="btn d-flex" type="button" href="#documents">Documents</a>
<a class="btn d-flex" type="button" href="#ii_dates">Impact Institute Dates</a>
<a class="btn d-flex" type="button" href="#positions">Positions</a>
<a class="btn d-flex" type="button" href="#districts">Districts</a>
<a class="btn d-flex" type="button" href="#dispositions">Dispositions</a>
<a class="btn d-flex" type="button" href="#doc_status">Document Statuses</a>
<a class="btn d-flex" type="button" href="#sql">SQL</a>
</div>
</div>
    ...
    <div class="row text-center">
            <div class="col-lg-12 mb-4">
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h3 class="mr-auto font-weight-bold text-dark">Companies</h3>
                </div> <!-- Card header -->
        ...
        <div class="row text-center">
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h3 class="mr-auto font-weight-bold text-dark">Documents</h3>
                </div> <!-- Card header -->
            ...
            <a href="#top">Return to Top</a>
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h3 class="mr-auto font-weight-bold text-dark">Impact Institute Dates</h3>
                </div> <!-- Card header -->
            ...
            <a href="#top">Return to Top</a>
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h3 class="mr-auto font-weight-bold text-dark">Positions</h3>
                </div> <!-- Card header -->
            ...
            <a href="#top">Return to Top</a>
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h3 class="mr-auto font-weight-bold text-dark">Districts</h3>
                </div> <!-- Card header -->
            ...
            <a href="#top">Return to Top</a>
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h3 class="mr-auto font-weight-bold text-dark">Dispositions</h3>
                </div> <!-- Card header -->
            ...
            <a href="#top">Return to Top</a>
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h3 class="mr-auto font-weight-bold text-dark">Document Statuses</h3>
                </div> <!-- Card header -->
            ...
            <a href="#top">Return to Top</a>
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h3 class="mr-auto font-weight-bold text-dark">SQL Input</h3>
                </div> <!-- Card header -->
